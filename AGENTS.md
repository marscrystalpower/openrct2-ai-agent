...
- Design a substantial circuit coaster for at least two trains when the ride type, block system, station, and budget support it. Plan block sections while laying out the track. Explain a deliberate single-train choice or a ride-type limitation.
